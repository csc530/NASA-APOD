...
public class APOD implements Comparable<APOD>{
	/**
	 * The possible media types for an astronomy picture of the day video or image
	 */
	public static final String[] mediaTypes = {"video", "image"};
	/**
	 * The minimum date an astronomy picture of the day can be found 1995-06-16, June 16, 1995
	 */
	public static final LocalDate minDate = LocalDate.parse("1995-06-16");
	/**
	 * The most recent date an astronomy picture opf the day can be found this will always return today's date
	 */
	 ...
	 * 		<li>
	 * 		If the obj is of the {@link APOD} class then their dates and titles are compared and if they are both equal then {@code true} is returned
	 * 		</li>
	 * 		<li>
	...
	/**
	 * A brief representation of the NASA's astronomy picture of the day This will output th
	 * <pre>
	 * date - title
	...
	/**
	 * This will return an Image of the A.P.O.D. It will return the hd image if there is one if not the lower resolution image will be returned. If the
	 * media type of the A.P.O.D. is a video the video's thumbnail is returned
	 *
	...
	/**
	 * This will return the video for the A.P.O.D. if the media type is an image null is returned
	 *
	...
	/**
	 * Uses {@link LocalDate}{@code .compareTo()} method <br/> Compares this object with the specified object for order.  Returns a negative integer, zero,
